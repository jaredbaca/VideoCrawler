...
public class TikTokSceneDetect implements Constants{

/**
 * Uses ProcessBuilder to call the TikTok scene detect shell script.	
 * @throws IOException
 */
	
public void detectScenes() throws IOException {
		
		String[] commands = {SHELL, TT_SCENE_DETECT};
